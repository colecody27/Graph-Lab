...
<div class="main-container">
  <div class="control-panel">
    ...
    <div class="control-item">
      <label for="startNodeInput">Enter Start Node:</label>
    ...
    <div class="control-item">
      <label for="goalNodeInput">Enter Goal Node:</label>
      <div class="input-group">
    ...
    <div class='flex justify-center mt-5 mb-2'>
    <button type="button" class="btn" on:click={stopVisualization()}>Stop Visualization</button>
    </div>
