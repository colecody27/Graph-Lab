...
<div class="main-container">
  <div class="control-panel">
    ...
    <div class="control-item">
      ...
      <div class="control-item">
        ...
        <div class="input-group">
          <input type="text" placeholder="Start node ex(A1, B1, C1)" bind:value={startName} class="input-text"  on:keydown={(event) => handleKeyDown(event, submitStartNode )}>
      ...
      <div class="control-item">
        ...
        <div class="input-group">
          <input type="text" placeholder="Goal node ex(B1,b1,C1)" bind:value="{goalName}" class="input-text"on:keydown={(event) => handleKeyDown(event, submitGoalNode )}>
    ...
    <div class='flex justify-center mt-5 mb-2'>
      <button type="button" class="btn variant-filled-secondary rounded-md"on:click={startVisualization}>Start Visualization</button>    
    </div>
